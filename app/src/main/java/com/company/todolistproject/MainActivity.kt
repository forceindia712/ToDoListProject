...
import com.company.todolistproject.adapter.RecyclerViewAdapter
import com.company.todolistproject.adapter.RecyclerViewAdapter.ClickListener
import com.company.todolistproject.databinding.ActivityMainBinding
import com.company.todolistproject.fragments.AlertDialogFragment
...
class MainActivity : FragmentActivity(), ClickListener {

    lateinit var binding: ActivityMainBinding
    lateinit var rvAdapter: RecyclerViewAdapter
    var itemList: ArrayList<MyItem> = arrayListOf()
    var itemListVisible: ArrayList<MyItem> = arrayListOf()
    ...
    private fun observeUI() {
        ...
        viewModel.itemslistNotDeleted.observe(this) {
            itemListVisible.clear()
            itemListVisible.addAll(it)
            rvAdapter.notifyDataSetChanged()
        }
    }

    private fun initUI() {
        rvAdapter = RecyclerViewAdapter(itemListVisible)
